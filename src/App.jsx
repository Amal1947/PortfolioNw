...
import amal from "./assets/formal.jpg";
function App() {
        ...
        <div className="w-full">
            ...
            <div className="mt-10 w-[50%]">
              ...
              >
                <Breadcrumbs>
                  <a
                    href="#"
                    className="opacity-60 cursor-default hover:text-black"
                  >
                    MERN developer
                  </a>
          ...
          <div className="mt-3 p-2  ">
            <ul className="flex  md:gap-10">
              <motion.button
                ...
                style={{
                  backgroundColor:
                    navigationSet.Home == "true" ? "black" : "white",
              ...
              <motion.button
                ...
                style={{
                  backgroundColor:
                    navigationSet.Projects == "true" ? "black" : "white",
              ...
              <motion.button
                ...
                style={{
                  backgroundColor:
                    navigationSet.Resume == "true" ? "black" : "white",
              ...
              <motion.button
                ...
                style={{
                  backgroundColor:
                    navigationSet.Contact == "true" ? "black" : "white",
          ...
          <div className="mt-5 mb-5">
            {navigationSet.Home === "true" ? (
              ...
              <Projects />
            ) : navigationSet.Resume === "true" ? (
              <Resume />
            ) : navigationSet.Contact === "true" ? (
              <Contact />
            ) : (
              ""
            )}
          ...
          <div className="flex  w-full mb-2">
            ...
            <div className="justify-end gap-3 flex w-full">
              <div className="mt-1">
                <a
                  href="https://github.com/Amal1947"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaGithub />
